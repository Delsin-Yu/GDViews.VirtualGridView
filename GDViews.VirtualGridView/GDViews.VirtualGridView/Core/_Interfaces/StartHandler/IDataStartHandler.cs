...
/// <summary>
/// View Start Handler is responsible for resolving the start position from the datasets when finding focus.
/// </summary>
public interface IDataStartHandler<in TArgument>
{
    ...
    /// <returns>The resolved start position, relative to the datasets.</returns>
